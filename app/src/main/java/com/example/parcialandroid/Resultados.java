...
public class ResultadoPartido extends AppCompatActivity {
    ...
    public  void resultado6 (View view){
        String eq1 =prueba1;
        String eq2 =prueba2;
        SharedPreferences clasificaciones = getSharedPreferences( "golesMarcados", Context.MODE_PRIVATE);
        ...
        if(dos.length()==0){
            ...
            Toast.makeText(this, "error no hay registros \uD83D\uDE00, resultado final: "+uno+" - "+dos, Toast.LENGTH_SHORT).show();
        }
    }
    public void Resultado7(View view){
